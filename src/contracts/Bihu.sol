...
/*
    ...
    function tipAnswer(uint _id, uint _answerId) public payable {
        require(_id > 0 && _id <= postCountQuestion);
        Answer memory _answer = questions[_id].answers[_answerId];
        address payable _author = _answer.author;
        address(_author).transfer(msg.value);
        _answer.tipAmount = _answer.tipAmount + msg.value;
        questions[_id].answers[_answerId] = _answer;
        emit AnswerTipped(postCountQuestion, _answer.tipAmount, _author);
    }
/*
